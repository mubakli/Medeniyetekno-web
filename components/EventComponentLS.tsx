...
// function EventComponent({title, presenter, date, time, description, poster}: EventProps) {
//   return (
...
//           </div>
//           {/* Adjusted dot positioning */}
//           <div className="absolute left-0 bottom-0 w-3 h-3 ml-[0.5px] bg-[#df9404] rounded-full -translate-x-1/2"></div>
...
//             <h3 className="text-xl opacity-70">{date} - {time}</h3>
//             <p>
//                 {description}
//             </p>
//             <button className="bg-[#1b62ff] text-white w-[200px] py-3 px-3 rounded-full self-end">
